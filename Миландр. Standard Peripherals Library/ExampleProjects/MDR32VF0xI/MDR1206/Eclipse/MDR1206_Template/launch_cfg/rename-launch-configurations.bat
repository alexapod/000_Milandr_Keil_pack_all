...
set "CONTENT_PATTERN=MDR1206_Template"
set "NAME_PATTERN=Template"

echo Script replaces "Template" in .launch configuration names and replaces "MDR1206_Template" inside .launch configuration files with user-defined value.

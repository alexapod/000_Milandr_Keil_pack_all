...
set "CONTENT_PATTERN=MDR32F02_Template"
set "NAME_PATTERN=Template"

echo Script replaces "Template" in .launch configuration names and replaces "MDR32F02_Template" inside .launch configuration files with user-defined value.

...
set "CONTENT_PATTERN=MDR32VF0xI_FreeRTOS_Template"
set "NAME_PATTERN=FreeRTOS_Template"

echo Script replaces "FreeRTOS_Template" in .launch configuration names and replaces "MDR32VF0xI_FreeRTOS_Template" inside .launch configuration files with user-defined value.

...
void CMy1986WSDDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_LIST2, m_baud);
...
BOOL CMy1986WSDDlg::OnInitDialog()
{
	...
	str = "115200";
	m_baud.AddString(str);
	m_baud.SetCurSel(InitParam.ibaud);
...
const DWORD baud[4]= {9600,19200,57600,115200};
	...
	InitParam.ibaud = m_baud.GetCurSel();
	...
	str = "boot load...ОК!";
	InsertStrToList();
	if(m_load.GetCheck()==BST_CHECKED)
	{
		Load();
		return;
	}
...
const DWORD baud[4]= {9600,19200,57600,115200};
	...
	com.dcb.BaudRate = baud[InitParam.ibaud];
	SetCommState(com.hCom, &com.dcb);
	str = "Run at 0x08000000...";
	InsertStrToList();
	txdbuf[0] = 'R';
